...
sap.ui.define(
    ...
    function (e, i) {
        ...
        var o = sap.ui.core
        o.AbsoluteCSSSize = e.createType(
            "sap.ui.core.AbsoluteCSSSize",
            {
                isValid: function (e) {
                    return /^([-+]?(0*|([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]))|calc\(\s*(\(\s*)*[-+]?(([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC])?)(\s*(\)\s*)*(\s[-+]\s|[*\/])\s*(\(\s*)*([-+]?(([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC])?)))*\s*(\)\s*)*\))$/.test(
                        e
                    )
                }
            },
        ...
        o.CSSSize = e.createType(
            "sap.ui.core.CSSSize",
            {
                isValid: function (e) {
                    return /^(auto|inherit|[-+]?(0*|([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]|[vV][wW]|[vV][hH]|[vV][mM][iI][nN]|[vV][mM][aA][xX]|%))|calc\(\s*(\(\s*)*[-+]?(([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]|[vV][wW]|[vV][hH]|[vV][mM][iI][nN]|[vV][mM][aA][xX]|%)?)(\s*(\)\s*)*(\s[-+]\s|[*\/])\s*(\(\s*)*([-+]?(([0-9]+|[0-9]*\.[0-9]+)([rR][eE][mM]|[eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]|[vV][wW]|[vV][hH]|[vV][mM][iI][nN]|[vV][mM][aA][xX]|%)?)))*\s*(\)\s*)*\))$/.test(
                        e
                    )
                }
            },
        ...
        o.CSSSizeShortHand = e.createType(
            "sap.ui.core.CSSSizeShortHand",
            {
                isValid: function (e) {
                    return /^(inherit|(auto|[-+]?(0*|(\d+|\d*\.\d+)([eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]|%))){1}(\s(auto|[-+]?(0*|(\d+|\d*\.\d+)([eE][mM]|[eE][xX]|[pP][xX]|[cC][mM]|[mM][mM]|[iI][nN]|[pP][tT]|[pP][cC]|%)))){0,3})$/.test(
                        e
                    )
                }
            },
        ...
        o.Collision = e.createType(
            "sap.ui.core.Collision",
            {
                isValid: function (e) {
                    return /^((flip|fit|none)( (flip|fit|none))?)$/.test(e)
                }
            },
            e.getType("string")
        )
        o.Design = { Standard: "Standard", Monospace: "Monospace" }
        o.Dock = e.createType(
            "sap.ui.core.Dock",
            {
                isValid: function (e) {
                    return /^((begin|left|center|right|end) (top|center|bottom))$/.test(
                        e
                    )
                }
            },
        ...
        o.Orientation = { Horizontal: "Horizontal", Vertical: "Vertical" }
        o.Percentage = e.createType(
            "sap.ui.core.Percentage",
            {
                isValid: function (e) {
        ...
        o.TextDirection = { LTR: "LTR", RTL: "RTL", Inherit: "Inherit" }
        o.TitleLevel = {
            Auto: "Auto",
            H1: "H1",
            H2: "H2",
        ...
        o.Wrapping = { None: "None", Soft: "Soft", Hard: "Hard", Off: "Off" }
        o.dnd = o.dnd || {}
        o.dnd.DropPosition = {
            On: "On",
            Between: "Between",
        ...
        var r = sap.ui.lazyRequire
        function a(e, i, o) {
            for (var a = 0; a < i.length; a++) {
                if (o) {
                    r(o, i[a].toLowerCase(), e + i[a])
                } else {
                    r(e + i[a], "new extend getMetadata")
                }
            }
        }
        r(
            "sap.ui.core.BusyIndicator",
            "show hide attachOpen detachOpen attachClose detachClose"
        )
        r("sap.ui.core.tmpl.Template", "registerType unregisterType")
        r("sap.ui.core.Fragment", "registerType byId createId")
        r(
            "sap.ui.core.IconPool",
            "createControlByURI addIcon getIconURI getIconInfo isIconURI getIconCollectionNames getIconNames getIconForMimeType"
        )
        r(
        ...
        r(
            ...
            "createPropertySetting format getNavigationPath" +
        ...
        var t =
            ...
            sap.ui.model.odata.AnnotationHelper
        if (t) {
            t.format.requiresIContext = true
            t.getNavigationPath.requiresIContext = true
            t.isMultiple.requiresIContext = true
            t.simplePath.requiresIContext = true
        }
        r("sap.ui", "xmlfragment", "sap.ui.core.Fragment")
        r("sap.ui", "jsfragment", "sap.ui.core.Fragment")
        r("sap.ui", "htmlfragment", "sap.ui.core.Fragment")
        a("sap.ui.model.", [
            "Filter",
            "Sorter",
            "json.JSONModel",
        ...
        a("sap.ui.core.", ["Component"], "sap.ui")
        a("sap.ui.core.tmpl.", ["Template"], "sap.ui")
        a("sap.ui.core.routing.", [
            "HashChanger",
            "History",
            "Route",
            "Router",
        ...
        a("sap.ui.core.service.", ["ServiceFactory", "Service"])
        return sap.ui.core
    }
)
